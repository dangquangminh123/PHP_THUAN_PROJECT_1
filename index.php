...
<!-- <script type="text/javascript">
	...
	<script src="https://www.paypal.com/sdk/js?client-id=AXlRlHLwBNVaMNpn1SpMX420IPDFvGExsE0OpVZORfmIkoFf8Ii9hbwpfsIyhtkQLOWeep9wh6KnVM87&currency=USD"></script>
	<script>
      paypal.Buttons({
        ...
        onApprove: function(data, actions) {
          ...
          return actions.order.capture().then(function(orderData) {
            // Successful capture! For dev/demo purposes:
                ...
                window.location.replace('http://shopmysqli.net/web_mysqli2/index.php?quanly=camon&thanhtoan=paypal');
        ...
        onCancle:function(data){
        	 window.location.replace('http://shopmysqli.net/web_mysqli2/index.php?quanly=thongtinthanhtoan');
        }
